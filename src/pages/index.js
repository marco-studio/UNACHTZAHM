      ...
      <div>
        ...
        >
          <div className="md:ml-8 md:mt-3 lg:ml-12">
            <div className="text-4xl font-medium md:text-3xl md:font-bold text-gray-100 lg:text-4xl">
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Eine Mischung aus Zauberei und Dosenbier! Es gibt zu viel Liebe und
            Hass, der kanalisiert werden muss. Es bedarf eines Podcasts, der
            sich dieser Sache annimmt. Schluss mit Arschkriecherei und
            Produktplatzierung. Es ist Zeit für ein ehrlicheres und echteres
            Leben. Plastikmüll gibt es bereits genügend in unseren Weltmeeren.
          </div>
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl" />
